...
public class CompanyPortalDbContext : DbContext
{
  ...
  // Define DbSets for your views here
  ...
  protected override void OnModelCreating(ModelBuilder modelBuilder)
  {
    ...
    {
      ep.ToView("EmployeeTitleSalaryHistoryView");
      ep.HasNoKey();

      ep.Property(r => r.EmployeeId).HasColumnName("EmployeeId");
      ep.Property(r => r.EmployeeName).HasColumnName("EmployeeName");
      ep.Property(r => r.Title).HasColumnName("Title");
      ep.Property(r => r.Salary).HasColumnName("SalaryAmount");
      ep.Property(r => r.FromDate).HasColumnName("FromDate");
      ep.Property(r => r.ToDate).HasColumnName("ToDate");
    });
  }
}